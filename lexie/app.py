...
from .device_api import device_api_bp
from .events import events_bp
from .room_api import room_api_bp
from .smarthome.caching import flush_cache
from .smarthome.models import db as sqla_db
from .smarthome.models import prepare_db
